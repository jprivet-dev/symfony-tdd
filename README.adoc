...
ENVIRONMENT
  ...
  env.local.prod                 Environment: Copy `.env.local.prod.dist` into `.env.local` (APP_ENV=prod)
  env.local.test                 Environment: Copy `.env.local.test.dist` into `.env.local` (APP_ENV=test)
