...
:uri-makefile: {uri-rel-file-base}Makefile
...
image:https://img.shields.io/badge/makefile-yes-blue["Makefile", link="{uri-makefile}"]
image:https://img.shields.io/github/license/jprivet-dev/symfony-tdd["MIT", link="{uri-license}"]
