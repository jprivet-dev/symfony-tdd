...
[TIP]
====
*Docker* : Bien intégrer le binaire `chromedriver` avec une image `alpine`.
Voir https://github.com/symfony/panther#docker-integration
====

[WARNING]
====
Panther ne permet pas de générer une couverture de code pour le moment.
Voir https://github.com/symfony/panther/issues/8.
====
