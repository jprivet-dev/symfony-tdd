...
Pour une application de Planing Poker, nous avons besoins d'une méthode qui puisse nous retourner
les 12 premiers termes de la suite de Fibonnaci.
...
sont récupérés et affichés dynamiquement avec un composant VueJs.

Les exemples sont entièrement inspirés de ceux présentés dans la page
