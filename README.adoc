...
ce dernier peut garantir au client que son implémentation réponde bien au besoin,
et que la fonctionnalité réagit bien aux cas limites auxquels elle pourrait être exposés.
