...
IDE
  ide.phpstorm.templates         PHPStorm: Copy all templates of project in fileTemplates folder of PHPStorm. | https://www.jetbrains.com/help/phpstorm/using-file-and-code-templates.html
```
// <<< block_makefile
