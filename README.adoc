...
J'intègre aussi les *tests JS autour des composants Vue.js* qui viennent dynamiser certaines pages générées par *Symfony*.
...
Pour repérer facilement l'avancé des sujets traités dans ce repo, *les titres sont tagués* de la façon suivante :
...
=== [!] Créer et tester un *composant Vue.js* [[creer-tester-composant-vue-js]]
