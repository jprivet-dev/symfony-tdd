...
|===
| https://github.com/jprivet-dev/symfony-tdd[master] | image:https://travis-ci.org/jprivet-dev/symfony-docker.svg?branch=master["Build Status", link="https://travis-ci.org/jprivet-dev/symfony-docker"]
