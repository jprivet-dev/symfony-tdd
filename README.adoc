...
=== [!] *Fixtures* : comment les récupérer dans vos tests par leur ids ?
...
Avec le `FixturesDecoration` de ce repo, il est possible de récupérer directement une fixture typée,
ce qui *facilie l'autocomplétion dans votre IDE* :
